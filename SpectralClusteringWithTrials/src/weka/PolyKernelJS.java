...
public class PolyKernelJS 
   ...
   */
  public PolyKernelJS(Instances data, int cacheSize, double exponent,
  ...
  public double evaluate(Instance inst1, Instance inst2)  throws Exception {
	 
	  	double k1 = unnormalizedKernel(inst1, inst1);
	    double k2 = unnormalizedKernel(inst2, inst2);
	    double normTerm = Math.sqrt( k1*k2 );
	    if (normTerm == 0.0)
	    	normTerm=0.00000000000001;
	  
	    double result = this.unnormalizedKernel(inst1, inst2)/normTerm;
	  
	    return result;
  }
  
  public double unnormalizedKernel(Instance inst1, Instance inst2)  throws Exception {
		 
	    double result;
	    result = this.dotProduct(inst1, inst2);
  ...
  double dotProduct(Instance inst1, Instance inst2)
  throws Exception {
